...
public class CuadernillosCuartoSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.listView = findViewById(R.id.cuadernillos_cuarto_s);
        ...
        StorageReference reference = this.mStorageRef.child("Cuadernillos 4 semestre");
        ...
        reference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                for (StorageReference item : listResult.getItems()) {
                    cuadernillosCuartoSemestre.add(item.getName() + "");
                }

                //Configuración del adaptador de la lista
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, cuadernillosCuartoSemestre);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), VisorPDFCuartoActivity.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(CuadernillosCuartoSActivity.this);
