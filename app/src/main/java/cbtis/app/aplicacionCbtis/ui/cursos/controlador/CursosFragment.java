...
public class CursosFragment extends Fragment implements RecyclerViewInterfaceCursos{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        this.listaElemento.add(new ListElementCursos(R.drawable.uveg_ingles, "Aprendizaje del idioma Inglés", "Uveg", "Estudia el idioma 100% en línea, a través de nuestros cursos autogestivos con acceso gratuito.", "https://uveg.edu.mx/index.php/es/ingles"));
