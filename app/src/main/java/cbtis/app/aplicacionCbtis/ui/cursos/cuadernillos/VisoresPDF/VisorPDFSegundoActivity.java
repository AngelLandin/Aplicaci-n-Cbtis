...
public class VisorPDFSegundoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_pdfsegundo);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Cuadernillos 2 semestre");
        ...
        mmFireBaseStorageRef.child(cuadernilloNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorPDFSegundoActivity.this, "Descarga fallida", Toast.LENGTH_LONG).show();
        });
    }
}