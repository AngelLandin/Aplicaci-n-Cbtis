...
public class VisorMecanicaVespertinoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_mecanica_vespertino);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Horarios Mecanica Vespertino");
        ...
        mmFireBaseStorageRef.child(horarioNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorMecanicaVespertinoActivity.this, "Descarga fallida.", Toast.LENGTH_LONG).show();
        });
    }
}