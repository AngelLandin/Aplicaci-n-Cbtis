...
public class VisorPDFTercerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_pdftercer);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Cuadernillos 3 semestre");
        ...
        mmFireBaseStorageRef.child(cuadernilloNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorPDFTercerActivity.this, "Descarga fallida.", Toast.LENGTH_LONG).show();
        });
    }
}