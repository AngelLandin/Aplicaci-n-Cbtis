...
import cbtis.app.aplicacionCbtis.ui.cursos.cuadernillos.VisoresPDF.VisorPDFSextoActivity;
...
public class CuadernillosSextoSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference reference = this.mStorageRef.child("Cuadernillos 6 semestre");
        ...
        reference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                for (StorageReference item : listResult.getItems()) {
                    cuadernillosSextoSemestre.add(item.getName() + "");
                }

                //Configuración del adaptador de la lista
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, cuadernillosSextoSemestre);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), VisorPDFSextoActivity.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(CuadernillosSextoSActivity.this);
