...
public class VisorPDFQuintoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_pdfquinto);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Cuadernillos 5 semestre");
        ...
        mmFireBaseStorageRef.child(cuadernilloNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorPDFQuintoActivity.this, "Descarga fallida", Toast.LENGTH_LONG).show();
        });
    }
}