...
public class VisorMecanicaMatutinoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_mecanica_matutino);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Horarios Mecanica Matutino");
        ...
        mmFireBaseStorageRef.child(horarioNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorMecanicaMatutinoActivity.this, "Descarga fallida.", Toast.LENGTH_LONG).show();
        });
    }
}