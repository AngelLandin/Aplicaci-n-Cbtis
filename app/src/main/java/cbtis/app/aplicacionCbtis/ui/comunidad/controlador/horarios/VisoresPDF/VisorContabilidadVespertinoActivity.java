...
public class VisorContabilidadVespertinoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_contabilidad_vespertino);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Horarios Contabilidad Vespertino");
        ...
        mmFireBaseStorageRef.child(horarioNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorContabilidadVespertinoActivity.this, "Descarga fallida.", Toast.LENGTH_LONG).show();
        });
    }
}