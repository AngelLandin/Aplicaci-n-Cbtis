...
public class ConvocatoriasFragment extends Fragment implements RecyclerViewInterfaceConvocatorias {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        elementos.add(new ListElement("Becas Santander", "En Becas Santander nos mueve tu progreso", "Nuestras becas y programas gratuitos están abiertos para todos, no tienes que ser cliente de Banco Santander ni tener título universitario o experiencia profesional.", "https://www.becas-santander.com/es/index.html?status=open&originCountry=MX"));
