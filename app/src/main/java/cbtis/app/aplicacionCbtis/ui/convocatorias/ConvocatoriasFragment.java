...
public class ConvocatoriasFragment extends Fragment implements RecyclerViewInterfaceConvocatorias {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listaConvocatorias.add(new ListElement("Becas Santander", "Excelencia Académica 2024", "Beca de manutención a alumnos de excelencia académica con un apoyo en efectivo y de entrega única por $100,000 pesos (cien mil pesos).", "https://app.santanderopenacademy.com/es/program/de-excelencia-academica-2024"));
