...
public class VisorLaboratorioMatutinoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_laboratorio_matutino);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Horarios Laboratorio Matutino");
        ...
        mmFireBaseStorageRef.child(horarioNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorLaboratorioMatutinoActivity.this, "Descarga fallida.", Toast.LENGTH_LONG).show();
        });
    }
}