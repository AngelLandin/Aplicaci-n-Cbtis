...
public class VisorContabilidadMatutinoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_contabilidad_matutino);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Horarios Contabilidad Matutino");
        ...
        mmFireBaseStorageRef.child(horarioNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorContabilidadMatutinoActivity.this, "Descarga fallida.", Toast.LENGTH_LONG).show();
        });
    }
}