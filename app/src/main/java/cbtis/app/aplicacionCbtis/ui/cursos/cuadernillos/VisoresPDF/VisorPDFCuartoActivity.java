...
public class VisorPDFCuartoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visor_pdfcuarto);
        ...
        StorageReference mmFireBaseStorageRef = mFireBaseStorage.getReference().child("Cuadernillos 4 semestre");
        ...
        mmFireBaseStorageRef.child(cuadernilloNombre).getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            Toast.makeText(VisorPDFCuartoActivity.this, "Descarga fallida", Toast.LENGTH_LONG).show();
        });
    }
}