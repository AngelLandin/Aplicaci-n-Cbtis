...
import cbtis.app.aplicacionCbtis.ui.cursos.cuadernillos.VisoresPDF.VisorPDFQuintoActivity;
...
public class CuadernillosQuintoSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.listView = findViewById(R.id.cuadernillos_quinto_s);
        ...
        StorageReference reference = this.mStorageRef.child("Cuadernillos 5 semestre");
        ...
        reference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                for (StorageReference item : listResult.getItems()) {
                    cuadernillosQuintoSemestre.add(item.getName() + "");
                }

                //Configuración del adaptador de la lista
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, cuadernillosQuintoSemestre);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), VisorPDFQuintoActivity.class);
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(CuadernillosQuintoSActivity.this);
