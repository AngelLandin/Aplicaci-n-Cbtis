...
public class CuadernillosPrimerSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference reference = this.mStorageRef.child("Cuadernillos primer s");
        ...
        reference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(CuadernillosPrimerSActivity.this);
